...
"""
Usage: python basset+_0001_ct

Loads pretrained resnet basset weights, specified in specified in @a args.basset_pretrained_path,
freezing those weights, then learns weights for gene expression.

Does NOT have access to mean.

Network used is same as basset+_resnet_nm_ct.py with different LR and does NOT freeze stage1 model.
